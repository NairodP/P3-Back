...
import com.chatop.location_app.dto.LoginDto;
import com.chatop.location_app.dto.RegisterDto;
import com.chatop.location_app.dto.TokenDto;
import com.chatop.location_app.dto.UserDto;
...
public class AuthController {
  ...
  public ResponseEntity<UserDto> getUser(@PathVariable Integer id) {
    ...
    UserDto userDTO = UserDto.builder()
            ...
            .updated_at(currentUser.getUpdatedAt().toString())
            .build();
