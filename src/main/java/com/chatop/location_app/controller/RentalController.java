...
public class RentalController {
  ...
  public ResponseEntity<RentalResponse> updateRental(@PathVariable Integer id, @ModelAttribute("rentals") RentalDto rentalDatas) throws IOException {

    Rental rental = rentalService.getRentalByID(id);
    User currentUser = userService.getCurrentUser();

    if (rental.getOwner().getId() != currentUser.getId())
